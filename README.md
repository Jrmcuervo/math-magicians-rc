...
Welcome to my math-magicians project
...
**math-magicians!** This project is to learn the basics of react, by creating a calculator.
...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone https://github.com/Jrmcuervo/math-magicians-rc.git
  ```
